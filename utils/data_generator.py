# -*- coding: utf-8 -*-
"""
Created on Nov 26 23:14:42 2021
...
def perturbed_dag(nodes, edges, E_dim):
    """Generate a random perturbed Directed Acyclic Graph (DAG) 
    with a given number of nodes and edges, dimensions of E."""
    G = nx.DiGraph()
    for i in range(nodes):
        G.add_node(i)
    while edges > 0:
